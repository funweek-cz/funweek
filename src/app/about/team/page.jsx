...
const FALLBACK_IMAGE_URL =
  "https://yrrpusyjrzcaqqnydsuo.supabase.co/storage/v1/object/sign/usables/image-unavailable.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9kZGU0ZDUyMC01MjUzLTQ0ZjYtYWE2NS0xNDljMTUyMDQ0NDIiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJ1c2FibGVzL2ltYWdlLXVuYXZhaWxhYmxlLnBuZyIsImlhdCI6MTc2NDA2NTI1MCwiZXhwIjoxNzk1NjAxMjUwfQ.bBKczE8BMiqTYxtjg_VH4mZCE52rIx20-_iODCnZqjc";
    ...
    <div className="relative inline-block">
      <button
        ...
        title={
          copied
            ? "Zkopírováno!"
            : `Discord: Kliknutím zkopírovat **${discordHandle}**`
        }
          ...
          >
            <div className="flex flex-row items-center gap-1">
              <div
                ...
                id="gabarito"
                style={{ backgroundColor: hexToRgba(member.depColor, 0.7) }}
              >
                {member.department}
              </div>
              {member?.availability && (
                ...
                >
                  {" "}
                  <img
                    src="https://i.imgur.com/iP7i12F.png"
                    width="10"
                ...
                <div className="flex text-white text-sm gap-2">
                  {member.socials?.email && (
                    <a href={member.socials.email}>
                      <img
                        src="https://i.imgur.com/XJocfuk.png"
                        width="20"
                  ...
                  {member.socials?.linkedin && (
                    ...
                    >
                      <img
                        src="https://i.imgur.com/Hap36Ei.png"
                        width="20"
                        className="hover:scale-110 transition-all opacity-50 hover:opacity-100"
                        alt="LinkedIn"
                      />
                  ...
                  {member.socials?.discord && (
                    <DiscordCopyButton discordHandle={member.socials.discord} />
                  )}
                </div>
              </div>
            </div>
