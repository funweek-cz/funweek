    ...
    return (
        <main className="w-full px-5 md:px-50 py-30 md:py-50 flex flex-col justify-center items-center">
            ...
            <div className="flex flex-row justify-center items-center gap-3">
                ...
                <Link href="/contact" className="font-bold mt-5 md:mt-10 px-4 py-2 rounded-lg block group border-funweek border-2 hover:scale-95 transition-all text-funweek ">
                    Kontaktujte nás
                </Link>
            </div>
        </main>
